...
IMPLEMENT_SHADER_TYPE(, FCubismSepMaskVS, TEXT("/Plugin/UnLive2DAsset/Private/CubismSepMask.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FCubismSepMaskPS, TEXT("/Plugin/UnLive2DAsset/Private/CubismSepMask.usf"), TEXT("MainPS"), SF_Pixel)
...
IMPLEMENT_SHADER_TYPE(, FCubismSepMaskPS_Invert, TEXT("/Plugin/UnLive2DAsset/Private/CubismSepMask.usf"), TEXT("MainPsInvert"), SF_Pixel)
...
)
{
    if (!tp_Model)
    {
        UE_LOG(LogUnLive2D, Error, TEXT("FModelRenders::DrawSepMask: Model not valid"));
        return;
    }
...
)
{
    ...
    RHICmdList.BeginRenderPass(RPInfo, TEXT("DrawSeparate"));
    {
        ...
        UE_LOG(LogUnLive2D, Verbose, TEXT("_matrixForDraw: %s"), *ts_MartixForDraw.ToString());
        UE_LOG(LogUnLive2D, Verbose, TEXT("_matrixForMask: %s"), *ConvertCubismMatrix(clipContext->_matrixForMask).ToString());
