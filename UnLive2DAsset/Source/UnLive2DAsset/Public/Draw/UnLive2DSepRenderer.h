...
public:
	...
	FUnLive2DRenderState(const UUnLive2D* InNewUnLive2D, TSharedRef<FUnLive2DRawModel> InUnLive2DRawModel);
...
public:
	...
	// 图片加载
	void LoadTextures(TSharedPtr<FUnLive2DRawModel> InUnLive2DRawModel);
	...
	// 获取图片
	class UTexture2D* GetRandererStatesTexturesTextureIndex(const int32& DrawableIndex) const;
	...
	// 更新遮罩纹理
	void InitRHI(FRHICommandListImmediate& RHICmdList, ERHIFeatureLevel::Type InFeatureLevel);
	...
	bool UnLive2DFillMaskParameter(const uint32 DrawableIndex, FUnLiveMatrix& ts_MartixForMask, FUnLiveVector4& ts_BaseColor, FUnLiveVector4& ts_ChanelFlag) const;
...
protected:
	...
	void UnLive2DFillMaskParameter(class CubismClippingContext* clipContext, FUnLiveMatrix& ts_MartixForMask, FUnLiveVector4& ts_BaseColor, FUnLiveVector4& ts_ChanelFlag) const;
